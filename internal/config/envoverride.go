...
// overlayEnv walks v (pointer to struct) and overlays matching BEACONS_* env
// vars onto it. revealValues includes overridden values (possibly secrets) in
// debug logs; when false only the key is logged.
