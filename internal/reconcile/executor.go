...
// this pass's store state, used to carry forward per-record failure counts onto
// desired records. If the store is a registry.Batcher, the pass's writes are
// deferred into one Batch call.
